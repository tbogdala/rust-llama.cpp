...
#include <stdbool.h>
    ...
    void *load_model(const char *fname, int n_ctx, int n_seed, bool memory_f16, bool mlock, bool embeddings, bool mmap, bool vocab_only, int n_gpu, int n_batch, const char *maingpu, const char *tensorsplit, bool numa);
    ...
    void *llama_allocate_params(const char *prompt, int seed, int threads, int tokens,
                                ...
                                bool prompt_cache_ro, float rope_freq_base, float rope_freq_scale, int n_draft);
